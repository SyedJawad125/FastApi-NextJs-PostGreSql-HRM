"""create education_experiences table

Revision ID: d2fa5d3181de
Revises: 7021b44ae4ab
Create Date: 2025-07-26 16:12:38.289695
...
revision: str = 'd2fa5d3181de'
down_revision: Union[str, Sequence[str], None] = '7021b44ae4ab'
...
def upgrade() -> None:
    """Upgrade schema."""
    # ### Custom commands to safely drop tables with dependencies ###
    op.execute('DROP TABLE IF EXISTS employee_holidays CASCADE')
    op.execute('DROP TABLE IF EXISTS holiday_calendars CASCADE')
    # ### end custom commands ###
